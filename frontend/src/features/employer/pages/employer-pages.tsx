...
<Input label="Minimum Salary (INR) *" required value={formData.salaryMin} onChange={e => setFormData({...formData, salaryMin: Number(e.target.value.replace(/\D/g, ''))})} placeholder="e.g. 500000" />
<Input label="Maximum Salary (INR) *" required value={formData.salaryMax} onChange={e => setFormData({...formData, salaryMax: Number(e.target.value.replace(/\D/g, ''))})} placeholder="e.g. 1000000" />
<Input label="Min Experience (Years) *" required value={formData.experienceMin} onChange={e => setFormData({...formData, experienceMin: Number(e.target.value.replace(/\D/g, ''))})} placeholder="e.g. 2" />
<Input label="Max Experience (Years) *" required value={formData.experienceMax} onChange={e => setFormData({...formData, experienceMax: Number(e.target.value.replace(/\D/g, ''))})} placeholder="e.g. 5" />
