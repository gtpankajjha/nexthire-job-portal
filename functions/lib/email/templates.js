...
exports.applicationConfirmationEmail = applicationConfirmationEmail;
exports.employerNewApplicationEmail = employerNewApplicationEmail;
...
function applicationConfirmationEmail(data) {
...
function employerNewApplicationEmail(data) {
...
function applicationStatusEmail(data, status) {
    const candidateName = escapeHtml(data.candidate.name);
    const jobTitle = escapeHtml(data.job.title);
    const company = escapeHtml(data.job.company);
    const messages = {
